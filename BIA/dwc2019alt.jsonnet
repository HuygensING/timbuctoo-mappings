...
rml.mappings([
  ...
  rml.mapping("bia_places", "2019_11_26_DWC_timbuctoo_upload.xlsx", 9, 
    ...
    rml.constantSource("https://schema.org/Place"),
    {
      ...
      "https://schema.org/containedInPlace": rml.joinField("country", "bia_countries", "country"),
  ...
  rml.mapping("bia_countries", "2019_11_26_DWC_timbuctoo_upload.xlsx", 9, 
    rml.templateSource(rml.datasetUri + "collection/Place/{country}"),
    rml.constantSource("https://schema.org/Place"),
    {
      "https://schema.org/name": rml.dataField(rml.types.string, rml.columnSource("country")),
