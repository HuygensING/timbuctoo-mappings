...
rml.mappings([
	...
	"emmigrantunits.csv",
	1,
	rml.templateSource(rml.datasetUri + "collection/migrant/{persistant_id}"),
        rml.constantSource(rml.datasetUri + "collection/migrant"),
	{
        ...
        rml.constantSource(rml.datasetUri + "collection/migrant"),
	{
          ...
          "http://schema.org/actorperson_relation_emmigrantunits": rml.dataField(rml.types.string, rml.columnSource("actorperson_relation_emmigrantunits")) ,
          "http://schema.org/actorperson_relation_emactors": rml.dataField(rml.types.string, rml.columnSource("actorperson_relation_emactors")) ,
          "http://schema.org/actorinstitution": rml.dataField(rml.types.string, rml.columnSource("actorinstitution")) ,
          "http://schema.org/receptorperson_relation_emmigrantunits": rml.dataField(rml.types.string, rml.columnSource("receptorperson_relation_emmigrantunits")) ,
          "http://schema.org/receptorperson_relation_emactors": rml.dataField(rml.types.string, rml.columnSource("receptorperson_relation_emactors")) ,
        ...
        rml.constantSource(rml.datasetUri + "collection/migrant"),
	{
          ...
          "http://schema.org/instelling_relation_emactorinstellingen": rml.dataField(rml.types.string, rml.columnSource("instelling_relation_emactorinstellingen")) ,
          ...
          "http://schema.org/instelling_relation_emactorinstitutions": rml.dataField(rml.types.string, rml.columnSource("instelling_relation_emactorinstitutions")) ,
        }),
    rml.mapping(
